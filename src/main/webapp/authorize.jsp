    ...
    <div class="main">
            ...
            <div class="row col-2 clear">
                <div class="block copy">
                    <div class="wrapper">
                        <h2><spring:message code="html.identified"/></h2>

                        <p class="row"><spring:message code="html.personal.code"/>: ${personalCode}</p>
                        <p class="row"><spring:message code="html.surname"/>: ${surName}</p>
                        <p class="row"><spring:message code="html.name"/>: ${name}</p>
                        <p class="row"><spring:message code="html.birthdate"/>: ${birthDate}</p>

                        <div class="row btns">
                            <form id="sendresponse" method="post" action="${responseCallback}">
                                <input type="hidden" name="SAMLResponse" value="${SAMLResponse}"/>
                                <button type="submit" class="btn btn--primary"><spring:message code="html.return.to.sp"/></button>
                            </form>
                        </div>
                    </div>
                </div>
