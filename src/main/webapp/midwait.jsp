...
<body class="is-mobile-subview" data-check-url="${checkUrl}">
    <div class="c-layout">
                    ...
                    <div class="c-tab-login__header hide-in-desktop">
                        <ul class="c-tab-login__nav">
                            <li class="c-tab-login__nav-item is-active">
                                <a class="c-tab-login__nav-link" href="#" data-tab="mobile-id">
                        ...
                        <div class="c-tab-login__content is-active" data-tab="mobile-id">
                            <div class="c-tab-login__content-wrap">
                                ...
                                <div class="c-tab-login__content-text">
                                    ...
                                    <p><spring:message code="html.mobile-id.instruction-check"/></p>
                                    <form class="c-form">
                                        <p><spring:message code="html.mobile-id.controlCode"/></p><p class="control-code">${challenge}</p>
                                    </form>
                                            ...
                                            <tr>
                                                <td>
                                                    <form action="auth" method="post" class="c-form">
                                                        ...
                                                        <button type="submit" class="c-btn c-btn--cancel"><spring:message code="html.common.cancel"/></button>
                                                    </form>
                                                </td>
                                                <td class="right-aligned-content">
                                                    <form id="mobileIdCheckForm" action="midcheck" method="post" class="c-form">
                                                        <input type="hidden" name="lang" value="${lang}"/>
                                                        <input type="hidden" name="sessionToken" value="${sessionToken}"/>
                                                        <noscript>
                                                            <button type="submit" class="c-btn c-btn--primary"><spring:message code="html.common.check"/></button>
                                                        </noscript>
                                                    </form>
                                                </td>
                                            </tr>
    ...
    <script src="static/scripts/mid-check.js" defer></script>
</body>
</html>