...
config = {
  ...
  DEST: {
    ...
    IMG: '../src/main/webapp/static/',
    FONTS: '../src/main/webapp/static/fonts/',
    CSS: '../src/main/webapp/static/',
    JS: '../src/main/webapp/static/scripts/'
  }
}
...
gulp.task('build:js_legalperson', function(cb) {
  pump([
    gulp.src(config.SRC.JS_LEGALPERSON),
    uglify(),
